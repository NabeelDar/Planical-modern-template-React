    ...
    <nav className={`navbar-navbar ${props.rootClassName} `}>
      ...
      <div className="navbar-nav-content">
        <div className="navbar-nav-links">
          ...
          <span className="navbar-link01 nav-link">Features</span>
          <span className="navbar-link02 nav-link">How it works</span>
          <span className="navbar-link03 nav-link">Testimonials</span>
          <span className="navbar-link04 nav-link">Prices</span>
          <span className="navbar-link05 nav-link">FAQ</span>
        </div>
...
Navbar.defaultProps = {
  ...
  image_alt1: 'image',
  image_alt2: 'image',
  image_src2: '/Branding/group%2011-500w.png',
  rootClassName: '',
  BrandingLogo:
